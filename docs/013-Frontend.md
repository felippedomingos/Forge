...
- **Project create dialog**: name, prefix, repository URL, root branch, a git-provider picker (`GET /plugins`), and an optional local checkout path up front — `POST /projects` ([[012-API]]). Closes the gap §4 used to flag ("no UI to create a project").
