...
- [ ] **Deploy agent — real implementation.** [[015-Deployment]] §2 proposes a concrete `PublishRecipe` shape — next step is adding the schema and wiring `DeployAsync` to execute it. The only remaining stub agent.
